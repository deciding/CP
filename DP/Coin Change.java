...
import java.io.*;
//Uva674
//this is much harder since we are requiring number of ways. we need (max value we should use, 
//remaining value) as our state in order to eliminate the repeat case.
