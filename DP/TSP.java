...
class Main { /* UVa10496 Collecting Beepers */
  // DP TSP, travel all cities with min cost
  ...
  //this is top-down, since when visit all cities is the base case, this func return the Value
  // Need to Have to complete the loop
  //bitmask include pos
